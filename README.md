# Executable Environment for OSF Project [3uyjt](https://osf.io/3uyjt/)
...
🚀 **MyBinder:** [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/code-inspect-binder/osf_3uyjt-f/HEAD?urlpath=rstudio)

   * This will launch the project in an interactive RStudio environment in your web browser.
   * Please note that Binder may take a few minutes to build the environment.

🚀 **NFDI JupyterHub:** [![NFDI](https://nfdi-jupyter.de/images/nfdi_badge.svg)](https://hub.nfdi-jupyter.de/r2d/gh/code-inspect-binder/osf_3uyjt-f/HEAD?urlpath=rstudio)
...
```bash
docker pull meet261/repo2docker-3uyjt-f:latest
```
...
```bash
docker run -it --name rstudio-dev --platform linux/amd64 -p 8888:8787 --user root meet261/repo2docker-3uyjt-f bash
```
...
[osf_3uyjt](https://github.com/code-inspect-binder/osf_3uyjt)
